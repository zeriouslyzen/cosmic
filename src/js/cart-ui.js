...
export function updateCartUI(items, subtotal, discount, stardustUsed) {
    ...
    if (items.length === 0) {
        ...
        if (cartTotalEl) cartTotalEl.textContent = `$${(subtotal - discount).toFixed(2)}`;
    }
